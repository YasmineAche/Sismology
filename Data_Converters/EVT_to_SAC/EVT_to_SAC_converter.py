...
This Python program converts seismic data from the 'kinemetrics_evt' format to SAC .sac files. It utilizes the ObsPy library for data processing for file I/O.
...
print("*" * len("Bienvenue au convertisseur Evt_SAC"))
print("Bienvenue au convertisseur Evt_SAC")
print("*" * len("Bienvenue au convertisseur Evt_SAC"))
